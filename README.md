...
<details>
  ...
  - Data para entrega no prazo regular: `21/06/2024 23:59`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-036-project-ting.git`
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-036-project-ting`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-036-project-ting/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-036-project-ting/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH36&template=betrybe/sd-0x-project-ting)
